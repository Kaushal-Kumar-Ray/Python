...
two sets. The union() method returns a new set whereas update() method adds item 
...
items that are similar to both the sets. The intersection() method
returns a new set whereas intersection_update()
